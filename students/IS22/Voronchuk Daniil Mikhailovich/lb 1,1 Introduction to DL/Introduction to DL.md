...
- График показывает четыре кластера точек в шахматном порядке: класс 0 (синие) и класс 1 (оранжевые) чередуются, наглядно демонстрируя линейную неразделимость задачи. Добавленный шум делает распределение более реалистичным.
