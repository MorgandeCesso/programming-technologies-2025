...
_Рисунок 1: Вывод о конфигурации_

## Этап №2. Подготовка тренировочной и тестовой выборок и их чтение.
На втором этапе мы скачали данные CIFAR100 и сформировали тренировочную и тестовую выборки. В данном варианте, мне попалась выборка с выдрой.

![alt text](photo/2.png)

_Рисунок 2: Изображение из CIFAR100_
...
_Рисунок 4: Графики CEE и Accurecy_
...
_Рисунок 6: Сохранение модели в ONNX_
