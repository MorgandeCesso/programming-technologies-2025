...
_Рисунок 2: Ответ ИИ с использование промпта_

Системный промпт был также перемещен в файл .env.

# Задание 2
Суть задание сделать так чтобы бот обращался по имени пользователя. Добавив к промпту строку, получения имени пользователя, бот стал начинать диалог и обращаться, используя имя пользователя.
```python
{message.from_user.full_name}
```
![alt text](photo/5.png)

_Рисунок 3: ответ ИИ с обращением к пользователю_
...
_Рисунок 4: Реакция ИИ на картинки_
