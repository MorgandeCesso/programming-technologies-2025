...
По результатам экспериментов оптимальным диапазоном для диалогового ассистента является 0.5–0.7.

---

## Хранение контекста диалога

Для хранения истории используется структура данных deque с ограничением длины:
